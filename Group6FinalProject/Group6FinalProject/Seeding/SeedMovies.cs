...
//    {
//        public static void SeedMovie(AppDbContext db)
//        {
...
//                Genre = db.Genre.FirstOrDefault(g => g.Genre == "Drama"),
//                Tagline = "Welcome to Jurassic Park",
//                PublishedDate = new DateTime(1993, 1, 1),
//                MPAARating = Format.PG13,
...
//                Genre = db.Genre.FirstOrDefault(g => g.Genre == "Children and Family"),
...
//                Genre = db.Genre.FirstOrDefault(g => g.Genre == "Action"),
...
//                Genre = db.Genre.FirstOrDefault(g => g.Genre == "Romance"),
...
//                Genre = db.Genre.FirstOrDefault(g => g.Genre == "Musical"),
...
//                Genre = db.Genre.FirstOrDefault(g => g.Genre == "Horror"),
...
//                Genre = db.Genre.FirstOrDefault(g => g.Genre == "Science Fiction"),
